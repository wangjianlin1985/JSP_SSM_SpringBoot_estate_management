...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">业主信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp" style="display:none;">添加业主</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<userInfoList.size();i++) {
            		...
            		UserInfo userInfo = userInfoList.get(i); //获取到业主对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在楼栋:<%=userInfo.getBuildingObj().getBuildingName() %>
			     	</div>
			     	<div class="field">
	            		房间号:<%=userInfo.getRoomNo() %>
			     	</div>
			     	<div class="field">
	            		姓名:<%=userInfo.getName() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="buildingObj_buildingId">所在楼栋：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_buildingObj_buildingId_edit" class="col-md-3 text-right">所在楼栋:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_roomNo_edit" class="col-md-3 text-right">房间号:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_roomNo_edit" name="userInfo.roomNo" class="form-control" placeholder="请输入房间号">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userPhoto_edit" class="col-md-3 text-right">业主照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_memo_edit" class="col-md-3 text-right">业主备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_memo_edit" name="userInfo.memo" rows="8" class="form-control" placeholder="请输入业主备注"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
