...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>违规id</td><td>违规住户</td><td>违规简述</td><td>处理状态</td><td>举报时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="violationDelete('<%=violation.getViolationId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="violationQueryForm" id="violationQueryForm" action="<%=basePath %>Violation/userFrontlist" class="mar_t15" method="post">
