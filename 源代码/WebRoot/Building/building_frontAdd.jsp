			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="buildingAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="building_buildingMemo" class="col-md-2 text-right">楼栋备注:</label>
						  	 <div class="col-md-8">
							    <textarea id="building_buildingMemo" name="building.buildingMemo" rows="8" class="form-control" placeholder="请输入楼栋备注"></textarea>
							 </div>
						  </div>
				          <div class="form-group">
