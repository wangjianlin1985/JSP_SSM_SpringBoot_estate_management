				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>楼栋id</td><td>楼栋名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="building_buildingMemo_edit" class="col-md-3 text-right">楼栋备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="building_buildingMemo_edit" name="building.buildingMemo" rows="8" class="form-control" placeholder="请输入楼栋备注"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (building, response, status) {
			if (building) {
				...
				$("#building_buildingMemo_edit").val(building.buildingMemo);
