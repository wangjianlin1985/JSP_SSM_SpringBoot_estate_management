			       ...
			       children:
			    	   [{
			    	    ...
			    	    },
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "RepairClass/repairClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "报修分类管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "RepairClass/repairClass_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "违规现象管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Violation/violation_add.jsp"
			    	   	},
			    		{
			    	   		text: "违规现象管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Violation/violation_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "住户缴费管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "FeeClass/feeClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "费用类别管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "FeeClass/feeClass_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加住户缴费",
			    		    state: "open",
